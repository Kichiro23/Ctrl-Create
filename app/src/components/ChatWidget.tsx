...
const FALLBACK_RESPONSES = [
  ...
  "Great question! I offer website development starting at ₱12,000, academic writing from ₱3,000 per chapter, and video editing. What are you looking for?",
  ...
  "For pricing, website packages start at ₱12,000 (Starter), ₱25,000 (Business), and ₱48,000 (Pro). Academic chapters are ₱3,000 each. Want a custom quote?",
  ...
  "Need thesis help? I cover all chapters (1–5), SPSS analysis, defense PPT, and Turnitin reports. Full thesis package is ₱12,000.",
